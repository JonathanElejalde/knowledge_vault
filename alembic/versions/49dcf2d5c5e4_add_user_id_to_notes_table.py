...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_learning_projects_category_id'), 'learning_projects', ['category_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_learning_projects_category_id'), table_name='learning_projects')
