...
export function ProjectsSidebar({ selectedProjectId, onProjectSelect }: ProjectsSidebarProps) {
  ...
  return (
    <div className="space-y-1 lg:flex lg:flex-col lg:h-full lg:min-h-0 lg:space-y-0">
      ...
      {/* Loading state */}
      {isLoading && (
        <div className="space-y-1 lg:flex-1 lg:overflow-y-auto lg:overscroll-contain lg:pr-1">
      ...
      {!isLoading && (
        <>
          ...
          {hasMore && projects.length > 0 && (
            <div className="pt-3 lg:pt-2 lg:shrink-0 lg:border-t lg:border-border-subtle/60">
              <Button
                variant="ghost"
                size="sm"
